      ...
      <div className="container-shell rounded-3xl border border-slate-200 bg-white/90 p-6 shadow-soft dark:border-slate-700 dark:bg-slate-900/80 sm:p-8">
        ...
        <div className="mt-6 grid gap-4 md:grid-cols-3">
          {whyChoose.map((reason, index) => (
            <div
              key={reason}
              className="rounded-2xl border border-slate-200 bg-gradient-to-b from-white to-slate-50 p-4 text-sm text-slate-800 transition duration-300 hover:-translate-y-1 dark:border-slate-700 dark:from-slate-900 dark:to-slate-800 dark:text-slate-200"
            >
