...
export function WhyChooseSection() {
  return (
    <section className="pb-16 sm:pb-20">
      <div className="container-shell rounded-3xl border border-slate-200 bg-white/92 p-6 shadow-[0_20px_44px_rgba(15,23,42,0.14)] dark:border-slate-700 dark:bg-slate-900/80 dark:shadow-[0_20px_48px_rgba(2,6,23,0.55)] sm:p-8">
        <h2 className="text-3xl font-black tracking-tight text-slate-900 dark:text-slate-100 sm:text-4xl">Why teams choose InternAI</h2>
        <p className="mt-2 max-w-2xl text-sm text-slate-700 dark:text-slate-200">
          A career-tech platform that aligns intern readiness and hiring priorities with measurable confidence.
        </p>
