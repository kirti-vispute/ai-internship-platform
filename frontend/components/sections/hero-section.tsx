  ...
  return (
    <section className="relative z-0 overflow-hidden bg-slate-950 pb-20 pt-24 sm:pb-24 sm:pt-28">
      <div className="relative min-h-[700px]">
        ...
        <div className="pointer-events-none absolute inset-0 z-10 bg-[radial-gradient(circle_at_18%_10%,rgba(56,189,248,0.14),transparent_34%),radial-gradient(circle_at_84%_12%,rgba(59,130,246,0.12),transparent_28%),linear-gradient(180deg,rgba(2,6,23,0.26)_0%,rgba(15,23,42,0.38)_50%,rgba(2,6,23,0.58)_100%)]" />

        <div className="container-shell relative z-20 flex min-h-[700px] items-center py-8">
          <ScrollReveal delayMs={80} className="z-20 max-w-2xl">
