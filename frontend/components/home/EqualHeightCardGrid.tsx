...
export function EqualHeightCardGrid({
  ...
  const cardToneClass =
    tone === "dark"
      ? "border-white/15 bg-white/5 shadow-[0_12px_28px_rgba(2,6,23,0.28)] hover:border-cyan-300/40 hover:bg-white/10 hover:shadow-[0_18px_36px_rgba(2,6,23,0.44)]"
      : "border-slate-200/80 bg-gradient-to-b from-white to-slate-50 shadow-[0_14px_34px_rgba(15,23,42,0.12)] hover:border-cyan-300/45 hover:shadow-[0_22px_40px_rgba(15,23,42,0.2)] dark:border-slate-700 dark:from-slate-900 dark:to-slate-900/80 dark:shadow-[0_16px_34px_rgba(2,6,23,0.55)] dark:hover:border-cyan-400/45 dark:hover:shadow-[0_24px_44px_rgba(2,6,23,0.66)]";
    ...
    <div className={cn("grid gap-4 md:grid-cols-3", gridClassName, className)}>
      {items.map((item) => (
        <article
          ...
          data-cursor="card"
          className={cn(
            "tilt-3d flex h-full flex-col rounded-2xl border p-5 transition duration-300 hover:-translate-y-1 hover:scale-[1.015]",
