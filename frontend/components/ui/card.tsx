...
export function Card({ title, subtitle, className, children }: CardProps) {
  return (
    <div
      className={cn(
        "surface-muted relative overflow-hidden p-5 transition duration-300 hover:-translate-y-1 hover:border-slate-300 hover:shadow-[0_20px_46px_rgba(15,23,42,0.16)] dark:hover:border-primary-500/50 dark:hover:shadow-[0_22px_46px_rgba(2,6,23,0.65)]",
        className
      )}
    >
